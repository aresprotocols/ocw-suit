...
use frame_support::pallet_prelude::{Member, PhantomData};
...
pub trait Config: pallet_babe::Config // where Self::T::AuthorityAres: From<pallet_babe::AuthorityId>
{
...
impl<T: Config, Inner: FindAuthor<u32>> FindAuthor<T::AuthorityId> for FindAccountFromAuthorIndex<T, Inner> {
